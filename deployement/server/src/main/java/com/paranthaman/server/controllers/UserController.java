...
public class UserController {
    ...
    @PostMapping("/order")
    public String addOrder(@RequestBody Order order, @RequestParam String uid) {
        Payment payment = makePayment(order.getPayment());
        order.setPayment(payment);
        return userService.addOrder(order, uid);
    }
