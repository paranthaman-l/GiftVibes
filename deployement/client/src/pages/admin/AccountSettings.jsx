...
const AccountSettings = () => {
    ...
    async function upload(e) {
        ...
        reader.onload = function (event) {
            ...
            fileUploadApi.post("", JSON.stringify(formData))
                .then(async response => {
                    const profile = "https://lh3.googleusercontent.com/d/" + response.data.fileUrl.id;
                    // setProfile()
                    setUser({ ...user, profile })
                    await AdminService.updateProfile(localStorage.getItem('uid'),profile).then((res) => {
                        toast.custom((t) => (
                            <div
    ...
    const handleProfileChange = async (e) => {
        ...
        // setProfile()
        // setUser({ ...user, profile:  })
        // await AdminService.updateProfile(localStorage.getItem('uid'), ).then((response) => {
        //     toast.custom((t) => (
        //         <div
        //             className={`bg-green text-white px-6 py-5 shadow-xl rounded-xl transition-all  ${t.visible
        //                 ? "opacity-100 translate-y-0"
