          ...
          <div className="text-darkGreen">
            ...
            <div className="flex items-center my-5">
              ...
              <label className="block">
                ...
                <input onChange={upload} name='image' type="file" className="cursor-pointer block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-lightGreen file:text-darkGreen hover:file:bg-opacity-60" />
              </label>
            </div>
            <div className="flex my-3 items-center justify-between">
