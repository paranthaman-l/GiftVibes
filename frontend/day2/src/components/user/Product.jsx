...
const Product = () => {
  return (
    <div className='h-[477px] w-[300px] duration-200 relative bg-white shadow mx-10 group flex flex-col text-darkGreen'>
      <div className="p-8">
        <div className="flex justify-between items-center">
          <p className='text-gray-400  uppercase'>Gift</p>
          <p className='text-green bg-lightGreen rounded-3xl text-sm py-1 px-2'>-22%</p>
        ...
        <div className="flex flex-col justify-between">
          <div className="mt-4">
            <p>Rating</p>
            <p className='line-clamp-2 hover:text-red duration-200 cursor-pointer'>Personalized Photo Frame Valentine’s Day Gift The Best Is Yet To Come</p>
          </div>
          <div className="flex items-center ">
            <p className='text-2xl font-semibold mt-3 mr-2'>₹390</p>
